---
title: "Examples: sketchit()"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Examples: sketchit()}
...
::: {.callout-note}
To enable communication between the browser and the Shiny server, you must supply the `shiny_message_loc` argument when using `sketchit()` in Shiny. This value must match the input ID used internally for message passing. If this argument is missing or empty, `sketchit()` will throw an error.
:::
